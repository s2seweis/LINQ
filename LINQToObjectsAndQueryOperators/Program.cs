...
namespace LINQToObjectsAndQueryOperators
{
    ...
    {
        // Collection of query operators (Documentation): https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/linq/standard-query-operators-overview
